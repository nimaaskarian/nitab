const types = {
  TOGGLE_DATE_ISPERSIAN: "toggle-date-ispersian",
  ...
  REMOVE_FROM_COMMAND: "remove-from-command",
  ADD_TO_COMMAND: "add-to-command",
  ...
  RESET_TASKBAR_ICONS: "reset-taskbar-icons",
